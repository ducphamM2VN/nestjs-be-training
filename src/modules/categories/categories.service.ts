...
export class CategoriesService {
    ...
    constructor(private firebaseService: FirebaseService) {
        this.collection = this.firebaseService.categoriesCollection
    }
    ...
    public async update(body: Category): Promise<IResponse> {
        return this.firebaseService.update(this.collection, body);
    }
    public async create(body: Category): Promise<IResponse> {
